...
export const GameCardSkeleton: React.FC = () => {
  return (
    <div className="flex flex-col rounded-2xl bg-brand-card/50 border border-brand-border/40 overflow-hidden animate-pulse">
      {/* Aspect ratio 3:4 matching GameCard */}
      <div className="relative aspect-[3/4] w-full bg-brand-surface/70">
